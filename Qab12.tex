...
\(6\,816\,241\) for \(U=2\), and \(16\,743\) for \(U=26\).
...
orientations, the residual certificate table records the prime \(p=1009\) and
modular gcd degree \(2\).  The independent residual verifier listed in
